...
While the object created by `sample_locally` function stores the dataset, explained instance and the name of the response variable, object returned by `add_predictions` function also stores the fitted black box model.
